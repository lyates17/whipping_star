...
<channel name="1mu1p" unit="MeV">
  <bins
      edges="250 300 350 400 450 500 550 600 650 700 750 800 850 900 950 1000"
      />
  <subchannel name="bnb"   />
  <!-- <subchannel name="dirt"  /> -->
  <subchannel name="extbnb"/>
...
<MultisimFile treename="sel_nue_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SEL1E1P_RUN1_FILE_NAME" scale="0.242" maxevents="100000" pot="9.803e22">
  <branch
      ...
      additional_weight="( xsec_corr_weight * (nu_energy_true>400) * (bdt_score>RUN1_BDT_CUT_VALUE) )"
...
<MultisimFile treename="sel_nue_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SEL1E1P_RUN3_FILE_NAME" scale="0.758" maxevents="100000" pot="4.707e22">
  <branch
      ...
      type="double"
      associated_subchannel="nu_uBooNE_1e1p_nue"
      additional_weight="( xsec_corr_weight * (nu_energy_true>400) * (bdt_score>RUN3_BDT_CUT_VALUE) )"
      eventweight_branch_name="sys_weights"
      />
</MultisimFile>

<MultisimFile treename="sel_nue_lowE_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SEL1E1P_RUN1_FILE_NAME" scale="0.242" maxevents="100000" pot="4.3e23">
  <branch
      name="nu_energy_reco"
      type="double"
      associated_subchannel="nu_uBooNE_1e1p_nue"
...
<MultisimFile treename="sel_nue_lowE_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SEL1E1P_RUN3_FILE_NAME" scale="0.758" maxevents="100000" pot="4.3e23">
  <branch
      name="nu_energy_reco"
      type="double"
      associated_subchannel="nu_uBooNE_1e1p_nue"
...
<MultisimFile treename="sel_nue_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SEL1E1P_RUN1_FILE_NAME" scale="0.242" maxevents="100000" pot="9.803e22">
  <branch
      ...
      additional_weight="( xsec_corr_weight*lee_weight * (nu_energy_true>400) * (bdt_score>RUN1_BDT_CUT_VALUE) )"
      eventweight_branch_name="sys_weights"
      />
</MultisimFile>
...
<MultisimFile treename="sel_nue_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SEL1E1P_RUN3_FILE_NAME" scale="0.758" maxevents="100000" pot="4.707e22">
  <branch
      ...
      type="double"
      associated_subchannel="nu_uBooNE_1e1p_lee"
      additional_weight="( xsec_corr_weight*lee_weight * (nu_energy_true>400) * (bdt_score>RUN3_BDT_CUT_VALUE) )"
      eventweight_branch_name="sys_weights"
      />
</MultisimFile>
...
<MultisimFile treename="sel_bnb_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SEL1MU1P_RUN1_FILE_NAME" scale="0.242" maxevents="100000" pot="4.715e20">
  <branch
      name="nu_energy_reco"
      type="double"
...
<MultisimFile treename="sel_bnb_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SEL1MU1P_RUN3_FILE_NAME" scale="0.758" maxevents="100000" pot="8.988e20">
  <branch
      name="nu_energy_reco"
      type="double"
      associated_subchannel="nu_uBooNE_1mu1p_bnb"
...
sel1e1p_run1_file_name = "input_to_sbnfit_v40_1e1p_run1_Jul13_opt.root"
sel1e1p_run3_file_name = "input_to_sbnfit_v40_1e1p_run3_Jul13_opt.root"
sel1mu1p_run1_file_name = "input_to_sbnfit_v40_1mu1p_run1_Jul13.root"
sel1mu1p_run3_file_name = "input_to_sbnfit_v40_1mu1p_run3_Jul13.root"
