...
<MultisimFile treename="sel_bnb_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SEL1MU1P_RUN1_FILE_NAME" scale="0.242" maxevents="100000" pot="4.715e20">
  <branch
      ...
      additional_weight="( xsec_corr_weight * ((nu_pdg==14)||(nu_pdg==-14)||(nu_interaction_ccnc==1)) * (nu_energy_true>400) * (bdt_score<BDT_CUT_VALUE) )"
      eventweight_branch_name="sys_weights"
      />
</MultisimFile>
...
<MultisimFile treename="sel_bnb_lowE_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SEL1MU1P_RUN1_FILE_NAME" scale="0.242" maxevents="100000" pot="1.631e21">
  <branch
      ...
      type="double"
      associated_subchannel="nu_uBooNE_1mu1p_bnb"
      additional_weight="( xsec_corr_weight * ((nu_pdg==14)||(nu_pdg==-14)||(nu_interaction_ccnc==1)) * (bdt_score<BDT_CUT_VALUE) )"
      eventweight_branch_name="sys_weights"
      />
</MultisimFile>
...
sel1e1p_run1_file_name = "input_to_sbnfit_v40_1e1p_run1_Aug14.root"
sel1e1p_run3_file_name = "input_to_sbnfit_v40_1e1p_run3_Aug14.root"
sel1mu1p_run1_file_name = "input_to_sbnfit_v40_1mu1p_run1_Aug12_opt.root"
sel1mu1p_run3_file_name = "input_to_sbnfit_v40_1mu1p_run3_Aug12_opt.root"
