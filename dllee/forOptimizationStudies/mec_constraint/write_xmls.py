...
<MultisimFile treename="sel_sig_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SELMEC_RUN1_FILE_NAME" scale="1.21" maxevents="100000" pot="4.715e20">
  <branch
      name="bdt_score"
      type="double"
      associated_subchannel="nu_uBooNE_mec_sig"
      additional_weight="( xsec_corr_weight * (bdt_score>BDT_CUT_VALUE) )"
      eventweight_branch_name="sys_weights"
      />
</MultisimFile>

<MultisimFile treename="sel_sig_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SELMEC_RUN3_FILE_NAME" scale="3.79" maxevents="100000" pot="8.987e20">
  <branch
      name="bdt_score"
      type="double"
      associated_subchannel="nu_uBooNE_mec_sig"
...
<MultisimFile treename="sel_bkg_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SELMEC_RUN1_FILE_NAME" scale="1.21" maxevents="100000" pot="4.715e20">
  <branch
      name="bdt_score"
      type="double"
      associated_subchannel="nu_uBooNE_mec_bkg"
      additional_weight="( xsec_corr_weight * (bdt_score>BDT_CUT_VALUE) )"
      eventweight_branch_name="sys_weights"
      />
</MultisimFile>

<MultisimFile treename="sel_bkg_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SELMEC_RUN3_FILE_NAME" scale="3.79" maxevents="100000" pot="8.987e20">
  <branch
      name="bdt_score"
      type="double"
      associated_subchannel="nu_uBooNE_mec_bkg"
...
<MultisimFile treename="sel_extbnb_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SELMEC_RUN1_FILE_NAME" scale="0.242" maxevents="100000" pot="1.012e20">
  <branch
      name="nu_energy_reco"
      type="double"
      associated_subchannel="nu_uBooNE_mec_extbnb"
      eventweight_branch_name="sys_weights"
      />
</MultisimFile>

<MultisimFile treename="sel_extbnb_tree" filename="/uboone/data/users/yatesla/othersys_mcc9/input_to_sbnfit/SELMEC_RUN3_FILE_NAME" scale="0.758" maxevents="100000" pot="1.536e20">
  <branch
      name="nu_energy_reco"
      type="double"
      associated_subchannel="nu_uBooNE_mec_extbnb"
...
sel1e1p_run1_file_name = "input_to_sbnfit_v40_1e1p_run1_Jun03.root"
sel1e1p_run3_file_name = "input_to_sbnfit_v40_1e1p_run3_Jun03.root"
...
selmec_run1_file_name = "input_to_sbnfit_v40_MEC_run1_Jun30.root"
selmec_run3_file_name = "input_to_sbnfit_v40_MEC_run3_Jun30.root"
...
for i in range(len(cut_values)):
        ...
        var_xml_str = var_xml_str.replace("SELMEC_RUN1_FILE_NAME", selmec_run1_file_name)
        var_xml_str = var_xml_str.replace("SELMEC_RUN3_FILE_NAME", selmec_run3_file_name)
