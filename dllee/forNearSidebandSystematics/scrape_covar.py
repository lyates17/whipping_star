...
var_dict = {'Enu_1e1p': 'nu_energy_reco',
            ...
            'Proton_TrackLength': 'proton_length_reco',
            'Lepton_TrackLength': 'lepton_length_reco'
}

for var in var_list:
    if var not in var_dict:
        print("WARNING: var {} not in var_dict!".forma(var))
        sys.exit(1)

for sel in ["samp1", "samp2", "samp3"]:
    for var in var_list:
