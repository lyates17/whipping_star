...
int main(int argc, char* argv[])
{
    ...
    if(mode_option == "feldman"){
        ...
        myfeld.SetCoreSpectrum(tag+".SBNspec.root");
        myfeld.SetBackgroundSpectrum(tag+".SBNspec.root",input_scale_subchannel,0.0);
        ...
        myfeld.SetCoreSpectrum(tag+".SBNspec.root");
        myfeld.SetBackgroundSpectrum(tag+".SBNspec.root",input_scale_subchannel,1.0);
        myfeld.GenerateScaledSpectra();
        ...
        std::vector<double> plotting_pvals = {0.682689, 0.90, 0.954500};
        //std::vector<std::string> plotting_strs = {"68%","90%","95%","99%"};
        //std::vector<std::string> plotting_strs = {"68%","90%","99%"};
        std::vector<std::string> plotting_strs = {"1#sigma (~68%)","90%","2#sigma (~95%)"};
	...
	l_probs->SetHeader("#splitline{#splitline{Classical}{Confidence}}{Level of Interval}");
        ...
        double mplot = v_true.back(); //0.8*v_true.back(); //7.0;
